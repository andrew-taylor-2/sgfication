  ...
  useEffect(() => {
    ...
    const loadWGoScripts = async () => {
      ...
      new WGo.BasicPlayer(document.getElementById('board'), {
        sgf: "(;FF[4]\nAB[bh][bi][bk][bp][bq][ch][ck][cp][di][dj][dk][dp][ek][em][en][eo][es][ff][fg][fm][fq][fr][ga][gk][gl][go][gp][ha][hb][hc][hf][hg][hk][ho][hq][ic][id][ig][ih][ii][ij][ik][il][im][ip][iq][jd][jj][jl][jr][ka][kb][ki][km][kr][lb][lc][le][li][ll][mc][ml][mm][mr][ni][nl][no][nr][ob][oc][oi][oj][ok][oo][op][oq][or][pd][pk][pp][qc][qe][qi][ql][qo][re][ro]AW[bg][br][ce][cg][ci][cj][cq][dc][dh][dq][eb][eh][ei][ej][ep][eq][er][fa][fh][fj][fk][fl][fn][fo][fp][gb][gc][gd][gf][gg][gj][gm][gn][hd][he][hh][hi][hj][hl][hm][hn][if][in][io][jb][jf][jg][jh][ji][jm][jn][jo][jp][kj][kk][kl][kq][la][lk][lq][lr][ls][ma][mb][mk][mn][mo][nb][nc][nd][nf][nj][nk][nm][nn][np][nq][od][ol][on][pe][pf][pl][pn][po][qf][qn][rf][rn]CA[UTF-8]GM[1]SZ[19])",
        // newline is fine but don't escape the \
